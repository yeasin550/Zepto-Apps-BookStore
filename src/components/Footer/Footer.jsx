        ...
        <div className="bg-[#1E1E1E] text-[#bcbec2]">
            <div className="w-11/12 mx-auto md:px-28 py-12 grid grid-cols-2 md:grid-cols-4 gap-12 justify-between">
                <div className="space-y-4">
                    ...
                    <p>Books are valuable sources of knowledge.</p>
                ...
                <div className="space-y-3 md:mr-0 mr-2">
                    ...
                    <p className="flex items-center gap-2"><FaMessage className="text-[#C0771E] text-[20px]" /> info@zeptoapps.com</p>
                </div>

            </div>
            <hr className="border- border-t-gray-300" />
            <p className="text-center py-6">Designed and Developed By Zepto Apps</p>
        </div>
    );
};
